        ...
        try {
            foreach ($rows as $index => $row) {
                ...
                if (auth('user')->user()->hasRole('Super Admin')) {
                    ...
                    $rules['class_id'] = ['required', 'exists:classes,id', new ClassBelongToSchool($row['grade_id'], $row['school_id']), new MaxStudents($row['class_id'])];
                    ...
                    $rules['class_id'] = ['required', 'exists:classes,id', new ClassBelongToSchool($row['grade_id'], $schoolId), new MaxStudents($row['class_id'])];
                }
